...
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK1_male_OG_1', 
...
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK1_female_OG_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK2_male_OG_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK2_female_OG_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK3_male_OG_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK3_female_OG_1',
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK4_male_OG_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK4_female_OG_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
...
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK1_male_OG_5', 
      package = 'QRISKvalidation'
    )), # list of locations of models
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK1_female_OG_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK2_male_OG_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK2_female_OG_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK3_male_OG_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK3_female_OG_5',
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK4_male_OG_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK4_female_OG_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
...
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK1_male_JJ_1', 
      package = 'QRISKvalidation'
    )), # list of locations of models
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK1_female_JJ_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK2_male_JJ_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK2_female_JJ_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK3_male_JJ_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK3_female_JJ_1',
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK4_male_JJ_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK4_female_JJ_1', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
...
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK1_male_JJ_5', 
      package = 'QRISKvalidation'
    )), # list of locations of models
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK1_female_JJ_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK2_male_JJ_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK2_female_JJ_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK3_male_JJ_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK3_female_JJ_5',
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK4_male_JJ_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
validationList[[length(validationList) + 1]] <- PatientLevelPrediction::createValidationDesign(
  ...
  plpModelList = list(
    createPackageModel(
      modelFolder = 'models/QRISK4_female_JJ_5', 
      package = 'QRISKvalidation'
    )),
  recalibrate = "weakRecalibration"
)
