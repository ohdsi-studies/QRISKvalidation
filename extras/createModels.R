...
plpModelQRISK4_male <- PatientLevelPrediction::createGlmModel(
  coefficients = data.frame(
    ...
    coefficient = c(0.065, 1.14, 1.15, 1.11, 1.19, 2.00, 2.08, 2.60, 1.00, 1.19, 1.47, 1.41, 1.04, 0.67, 0.66, 0.72, 0.81, 1.17, 2.35, 1.62, 3.28, 2.03, 2.20, 1.19, 2.59, 1.70, 1.41, 1.64, 1.68, 1.18, 1.37, 1.66, 1.49, 2.06, 5.45, 1.40)
  ), 
  intercept = 0, 
  mapping = "", #TODO 
  populationSettings = populationSettings,
...
plpModelQRISK4_female <- PatientLevelPrediction::createGlmModel(
  coefficients = data.frame(
    ...
    coefficient = c(0.0635, 1.16, 1.14, 1.26, 1.19, 2.12, 2.30, 2.90, 1.00, 1.13, 1.56, 1.28, 0.98, 0.94, 0.76, 0.68, 0.94, 1.45, 3.18, 1.46, 4.52, 2.49, 2.20, 1.28, 4.50, 1.81, 1.46, 1.70, 2.22, 1.24, 1.22, 1.85, 3.50, 1.55, 2.13, 4.52, 1.18, 1.56) 
  ), 
  intercept = 0, 
  mapping = "", #TODO 
  populationSettings = populationSettings,
