...
plpModelQRISK3_female_OG_10 <- PatientLevelPrediction::createGlmModel(
  ...
  coefficients = data.frame(
    ...
    coefficient = c(
      # townsend
      0.0772237905885901080000000,
      
      # race/ethnicity
      0, 0, 0.2804031433299542500000000, 0.5629899414207539800000000, 0.2959000085111651600000000,
      0.0727853798779825450000000, 0.0727853798779825450000000,0.0727853798779825450000000,
      -0.1707213550885731700000000, -0.3937104331487497100000000, -0.3937104331487497100000000,
      -0.3263249528353027200000000, -0.1712705688324178400000000,
      
      # smoker low to high
      0, 0.1338683378654626200000000, 0.5620085801243853700000000, 0.6674959337750254700000000,
      0.8494817764483084700000000,
      
      # binary
      1.5923354969269663000000000,
      0.2523764207011555700000000,
      0.5952072530460185100000000,
      0.3012672608703450000000000,
      0.2136480343518194200000000,
      0.6519456949384583300000000,
      0.1255530805882017800000000,
      0.7588093865426769300000000,
      0.5093159368342300400000000,
      1.7267977510537347000000000,
      1.0688773244615468000000000,
      0.4544531902089621300000000,
      
      # measurements
      -8.1388109247726188000000000,
      0.7973337668969909800000000,
      0.2923609227546005200000000,
      -4.1513300213837665000000000,
      0.1533803582080255400000000,
      0.0131314884071034240000000,
      0.0078894541014586095000000,
      
      # interactions - age 1
      
      -4.7057161785851891000000000, # Former smoker
      -2.7430383403573337000000000,
      -0.8660808882939218200000000,
      0.9024156236971064800000000,
      19.9380348895465610000000000, #afib
      ...
      23.8026234121417420000000000, #bmi 1
      -71.1849476920870070000000000, #bmi2
      0.9946780794043512700000000, #fhc
      0.0341318423386154850000000, #sbp
      -1.0301180802035639000000000, #townsend
      
      # interactions - age 2
      -0.0755892446431930260000000, # smoke
      -0.1195119287486707400000000, # smoke
      -0.1036630639757192300000000, # smoke
      -0.1399185359171838900000000, # smoke
      ...
      0.5236995893366442900000000, #bmi 1
      0.0457441901223237590000000, #bmi 2
      -0.0768850516984230380000000, # fhc
      -0.0015082501423272358000000, #sbp
      -0.0315934146749623290000000 # townsend
                   )  
  ), 
  intercept = 0, 
  mapping = "function(x){ sapply(x, function(x){
  (1 - (0.988876402378082)^exp(x) )
})}", 
