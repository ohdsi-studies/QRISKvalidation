...
#' 
#' @export
createQRISK2BMaleOG10 <- function(
...
plpModelQRISK2B_male_OG_10 <- PatientLevelPrediction::createGlmModel(
...
return(plpModelQRISK2B_male_OG_10)
}
