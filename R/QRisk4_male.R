...
plpModelQRISK4_male_OG_10 <- PatientLevelPrediction::createGlmModel(
  ...
  coefficients = data.frame(
    ...
    coefficient = c(
      ...
      0.0386352325794289963578620, 0.0386352325794289963578620, 0.0386352325794289963578620, -0.4041201761899239075503942, 
     -0.4198460764758025209886227, -0.4198460764758025209886227, -0.3309767222744185444227583, -0.2061952053636268988867641,
